...
export const updateWeather = function (lat, lon) {
  ...
  img.src = 'https://www.7timer.info/bin/civillight.php?lon=' + lon + '&lat=' + lat + '&lang=zh-CN&ac=0&unit=metric&tzshift=0';
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    card.innerHTML = `
        <h2 class="title-2 card-title">现在</h2>
        <div class="weapper">
    ...
    fetchData(url.airPollution(lat, lon), function (airPollution) {
      ...
      card.innerHTML = `
      <h2 class="title-2" id="highlights-label">今日指数</h2>
                        <div class="highlight-list">
                            <div class="card card-sw highlight-card one">
                                <h3 class="title-3">空气质量指数</h3>
                                <div class="wrapper">
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        <div class="card card-sw slider-card">
            ...
            <img src="./assets/images/weather_icons/direction.png" width="48" height="48"
                loading="lazy" alt="" class="weather-icon" style="transform: rotate(${windDirection - 100
          }deg)" />
      ...
      forecastSection.innerHTML = `
      <h2 class="title-2" id="forecast-label">5日预报</h2>
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        <p class="label-1">${date.getDate()} ${module.monthsNames[date.getMonth()]
          }</p>
